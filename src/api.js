...
export const SUPPORTED_TOKENIDS = Object.keys(SUPPORTED_DIGITAL_CURRENCIES).reduce((out, pluginId) => {
  return [...out, ...Object.keys(SUPPORTED_DIGITAL_CURRENCIES[pluginId]).reduce((out2, currencyCode) => [...out2, { pluginId, currencyCode }], [])]
}, [])

export const getSimplexId = (pluginId, currencyCode) => SUPPORTED_DIGITAL_CURRENCIES[pluginId][currencyCode]
